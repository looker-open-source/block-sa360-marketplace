view: p_keyword_conversion_events {
  sql_table_name: `@{SA_360_SCHEMA}.p_KeywordFloodlightAndDeviceStats_@{ADVERTISER_ID}`
    ;;
...
#     hidden: yes
  ...
  measure: total_actions {
    type: sum
    sql: ${dfa_actions} ;;
    drill_fields: [date_date,total_actions]
  }

  measure: total_transactions {
    type: sum
    sql: ${dfa_transactions} ;;
    drill_fields: [date_date,total_transactions]
  }
  ...
  measure: total_conversions {
    ...
    drill_fields: [date_date, keyword.keyword_text, total_conversions]
  }
  ...
  measure: total_revenue {
    ...
    sql: ${dfa_revenue} ;;
    drill_fields: [date_date, keyword.keyword_text, total_revenue]
  }
  ...
  measure: ROAS {
    ...
    sql: 1.0 * ${total_revenue} / NULLIF(${p_keyword_events.total_cost},0)  ;;
    drill_fields: [date_date, keyword.keyword_text, ROAS, total_revenue, keyword_events.total_cost]
  }
  ...
  measure: cost_per_acquisition {
    ...
    sql: ${p_keyword_events.total_cost}*1.0/NULLIF(${total_conversions},0) ;;
    drill_fields: [date_date, keyword.keyword_text, cost_per_acquisition, keyword_events.total_cost, total_conversions]
  }
  ...
  measure: conversion_rate {
    ...
    sql: 1.0 * ${total_actions} / NULLIF(${p_keyword_events.total_clicks},0)  ;;
    drill_fields: [date_date, keyword.keyword_text, conversion_rate, total_actions, keyword_events.total_clicks]
  }
