...
##### Ad Event Metrics #####
  ...
  measure: total_cost {
    ...
    sql: ${cost} ;;
    drill_fields: [ad_group.ad_group,  total_cost, total_clicks, ad_group_conversion_events.total_revenue]
  }
  ...
  measure: click_through_rate {
    ...
    drill_fields: [ad_group.ad_group, click_through_rate, total_clicks, total_impressions]
  }
  ...
  measure: cost_per_click {
    ...
    drill_fields: [ad_group.ad_group, cost_per_click, total_cost, total_clicks]
  }
