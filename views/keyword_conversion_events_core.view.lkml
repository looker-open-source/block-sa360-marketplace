include: "//@{CONFIG_PROJECT_NAME}/keyword_conversion_events.view.lkml"


view: keyword_conversion_events {
  extends: [keyword_conversion_events_config]
}

###################################################

view: keyword_conversion_events_core {
  sql_table_name: `@{SA_360_SCHEMA}.KeywordFloodlightAndDeviceStats_@{ADVERTISER_ID}`;;
  ...
  measure: ROAS {
    ...
    drill_fields: [_data_date, keyword.keyword_text, ROAS, total_revenue, keyword_events_core.total_cost]
  }
  ...
  measure: cost_per_acquisition {
    ...
    drill_fields: [_data_date, keyword_core.keyword_text, cost_per_acquisition, keyword_events.total_cost, total_conversions]
  }
